...
public class InstallFinishFragment extends BaseFragment {
    private static String TAG="安装完成";

    @BindView(R.id.fragment_installnohander_lv)
    ListView fragmentInstallnohanderLv;
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        List<InstallList> list  = installListService.getAllYInstallList();
